...
input = [
  { forward: 5 }, { forward: 1 }, { forward: 3 }, { down: 8 }, { up: 6 }, { down: 5 }, { forward: 6 }, { down: 9 }, { down: 7 }, { up: 9 }, { down: 9 }, { forward: 5 }, { forward: 3 }, { down: 3 }, { forward: 1 }, { forward: 8 }, { down: 8 }, { forward: 6 }, { forward: 9 }, { forward: 5 }, { down: 8 }, { up: 1 }, { forward: 4 }, { forward: 8 }, { down: 4 }, { forward: 2 }, { down: 1 }, { up: 8 }, { up: 9 }, { down: 4 }, { forward: 5 }, { up: 9 }, { forward: 1 }, { down: 9 }, { down: 7 }, { down: 4 }, { down: 6 }, { down: 3 }, { forward: 5 }, { up: 4 }, { up: 7 }, { forward: 1 }, { down: 1 }, { up: 3 }, { forward: 8 }, { down: 8 }, { up: 2 }, { forward: 2 }, { down: 7 }, { down: 7 }, { down: 4 }, { forward: 3 }, { down: 5 }, { up: 8 },
  { down: 6 }, { up: 2 }, { down: 7 }, { forward: 8 }, { down: 7 }, { down: 7 }, { up: 6 }, { forward: 8 }, { up: 1 }, { down: 4 }, { forward: 1 }, { down: 1 }, { down: 9 }, { down: 1 }, { down: 7 }, { forward: 2 }, { forward: 3 }, { up: 8 }, { up: 1 }, { forward: 4 }, { forward: 7 }, { forward: 9 }, { up: 8 }, { down: 9 }, { down: 3 }, { down: 5 }, { down: 5 }, { forward: 7 }, { forward: 3 }, { up: 7 }, { forward: 6 }, { up: 6 }, { forward: 3 }, { down: 2 }, { down: 5 }, { down: 2 }, { up: 6 }, { down: 5 }, { down: 5 }, { forward: 7 }, { forward: 2 }, { forward: 7 }, { down: 6 }, { forward: 1 }, { forward: 8 }, { up: 6 }, { forward: 2 }, { down: 5 }, { forward: 3 }, { up: 2 }, { forward: 3 }, { down: 2 }, { forward: 4 }, { forward: 6 },
...
RSpec.describe 'calculate the multiplied position' do
  ...
  def calculate_final_position(array)
    ...
    array.each do |h|
      total_aim += h[:down] unless h[:down].nil?
      total_aim -= h[:up] unless h[:up].nil?

      unless h[:forward].nil?
        total_horizon += h[:forward]
        total_depth += h[:forward] * total_aim
      end
    end
  ...
  it 'returns the multiplied position of horizontal position and depth' do
    expect(calculate_final_position(input_1)).to eql(900)
    expect(calculate_final_position(input)).to eql(1_880_593_125)
  end
end
